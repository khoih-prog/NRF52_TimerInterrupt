...
int NRF52_ISR_Timer::findFirstFreeSlot() 
{
  // all slots are used
...
int NRF52_ISR_Timer::setTimer(unsigned long d, timer_callback f, unsigned n) 
{
  return setupTimer(d, (void *)f, NULL, false, n);
}

int NRF52_ISR_Timer::setTimer(unsigned long d, timer_callback_p f, void* p, unsigned n) 
{
  return setupTimer(d, (void *)f, p, true, n);
}

int NRF52_ISR_Timer::setInterval(unsigned long d, timer_callback f) 
{
  return setupTimer(d, (void *)f, NULL, false, RUN_FOREVER);
}

int NRF52_ISR_Timer::setInterval(unsigned long d, timer_callback_p f, void* p) 
{
  return setupTimer(d, (void *)f, p, true, RUN_FOREVER);
}

int NRF52_ISR_Timer::setTimeout(unsigned long d, timer_callback f) 
{
  return setupTimer(d, (void *)f, NULL, false, RUN_ONCE);
}

int NRF52_ISR_Timer::setTimeout(unsigned long d, timer_callback_p f, void* p) 
{
...
void NRF52_ISR_Timer::enableAll() 
{
...
void NRF52_ISR_Timer::disableAll() 
{
...
unsigned NRF52_ISR_Timer::getNumTimers() 
{
  return numTimers;
}
